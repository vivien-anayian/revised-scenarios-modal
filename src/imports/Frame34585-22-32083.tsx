import svgPaths from "./svg-oslz1kpotv";
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_22_32093)" id="Plus">
          <path d={svgPaths.p1383ff00} fill="var(--fill-0, #4837B9)" id="Shape" />
        </g>
        <defs>
          <clipPath id="clip0_22_32093">
...
function Upload() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Upload">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Upload">
          <path d={svgPaths.p1938f540} fill="var(--fill-0, white)" id="Shape" />
        </g>
      </svg>
    </div>
  );
...
function BackArrow() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="BackArrow">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="BackArrow">
          <path d={svgPaths.p35e4fa80} fill="var(--fill-0, #4837B9)" id="Shape" />
        </g>
      </svg>
    </div>
  );
