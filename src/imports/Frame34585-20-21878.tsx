import svgPaths from "./svg-cwa273ru73";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="AI Stars">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="AI Stars">
          <g id="Vector">
            <path d={svgPaths.p392ab080} fill="url(#paint0_linear_20_21888)" />
            <path d={svgPaths.p37a0ec40} fill="url(#paint1_linear_20_21888)" />
            <path d={svgPaths.p1f950c80} fill="url(#paint2_linear_20_21888)" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_20_21888" x1="1.20002" x2="14.8" y1="7.66666" y2="7.66666">
            <stop stopColor="#C928FF" />
            <stop offset="0.33" stopColor="#8B28FF" />
            <stop offset="0.66" stopColor="#5528FF" />
            <stop offset="1" stopColor="#181818" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_20_21888" x1="1.20002" x2="14.8" y1="7.66666" y2="7.66666">
            <stop stopColor="#C928FF" />
            <stop offset="0.33" stopColor="#8B28FF" />
            <stop offset="0.66" stopColor="#5528FF" />
            <stop offset="1" stopColor="#181818" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_20_21888" x1="1.20002" x2="14.8" y1="7.66666" y2="7.66666">
            <stop stopColor="#C928FF" />
            <stop offset="0.33" stopColor="#8B28FF" />
            <stop offset="0.66" stopColor="#5528FF" />
            <stop offset="1" stopColor="#181818" />
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="deal settings">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_20_21885)" id="deal settings">
          <g id="Shape">
